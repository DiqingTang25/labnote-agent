...
const Beaker = createLucideIcon("beaker", __iconNode$10);
const __iconNode$$ = [
...
const Book = createLucideIcon("book", __iconNode$_);
const __iconNode$Z = [
...
const FileBraces = createLucideIcon("file-braces", __iconNode$L);
const __iconNode$K = [
  [
    "path",
    {
...
const FilePlusCorner = createLucideIcon("file-plus-corner", __iconNode$K);
const __iconNode$J = [
  [
    "path",
    {
...
const ListChecks = createLucideIcon("list-checks", __iconNode$x);
